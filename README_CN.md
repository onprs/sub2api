...
- `security.url_allowlist.allow_anthropic_apikey_custom_hosts` 允许 Anthropic API-Key 账号填写任意公网 HTTPS 中转地址（默认 true；设为 false 则其 base_url 也受 upstream_hosts 白名单约束）
