export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        antigravityUserAgentVersionPlaceholder: '1.1.13',
        antigravityUserAgentVersionHint: 'Leave empty to use ANTIGRAVITY_USER_AGENT_VERSION or the built-in default 1.1.13; when set, the admin setting takes precedence.',
