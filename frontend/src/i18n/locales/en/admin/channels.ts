export default {
    ...
    channels: {
      ...
      emptyModelsInPricing: 'A pricing entry must include at least one model',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiModeResponsesHint: 'Use /v1/responses with default instructions + input; suitable for self-check, Codex, and OpenCode Go Responses models.',
        ...
        openRouterEndpointHint: 'Use the current service origin without a path and select a local OpenRouter group key. The monitor appends /chat/completions automatically.',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Enter API Key',
        apiKeyEditPlaceholder: 'Leave blank to keep current key',
        clinePassAPIKeyHint: 'The current service requires a local group key. The official Cline endpoint requires a Cline-issued API key; these keys are not interchangeable.',
        openRouterAPIKeyHint: 'The current service requires a local group key. The official OpenRouter endpoint requires an OpenRouter-issued API key; these keys are not interchangeable.',
        useMyKey: 'Use my key',
        ...
        clinePassIntervalHint: 'Each check performs a real generation and consumes ClinePass quota. Use a longer interval.',
      ...
      advanced: {
        ...
        bodyModeHintMerge: 'Shallow-merge with the default body; user fields win but routing fields such as model / messages / instructions / input / contents are protected (use Replace to change those).',
    ...
    subscriptions: {
      ...
      planHint: 'The selected plan determines the subscription group and quota configuration',
      ...
      resetSelectedQuota: 'Reset selected quota',
      resetFilteredQuota: 'Reset filtered quota',
      resetQuotaTitle: 'Reset Usage Quota',
      resetQuotaConfirm: "Reset selected rolling quota windows for '{user}'?",
      resetQuotaSelectedConfirm: 'Reset selected rolling quota windows for {count} selected subscriptions?',
      resetQuotaFilteredConfirm: 'Reset selected rolling quota windows for {count} subscriptions in the current filtered result?',
      resetQuotaWindows: 'Quota windows to reset',
      resetQuotaHierarchyHint: 'Rolling windows are hierarchical. If multiple rolling windows are selected, only the largest selected window is executed to avoid double deduction.',
      quotaWindowFiveHour: '5-hour window',
      quotaWindowSevenDay: '7-day window',
      quotaWindowThirtyDay: '30-day window',
      resetFiveHourHint: 'Zero 5h usage and subtract that cleared amount from 7d/30d totals.',
      resetSevenDayHint: 'Zero 7d and its child 5h usage, then subtract the cleared 7d amount from the 30d total.',
      resetThirtyDayHint: 'Zero 30d and its child 7d/5h usage.',
      selectQuotaWindow: 'Select at least one quota window',
      selectedCount: '{count} subscriptions selected',
      selectCurrentPage: 'Select current page',
      noSelection: 'Select subscriptions first',
      quotaResetSuccess: 'Quota reset successfully',
      quotaResetPartialSuccess: 'Quota reset partially completed: {success} succeeded, {failed} failed',
      quotaResetCacheWarning: 'Quota reset completed, but cache invalidation reported warnings. Data may take a moment to refresh.',
      ...
      guide: {
        ...
        actions: {
          ...
          resetQuota: 'Reset Quota',
          resetQuotaDesc: 'Reset selected rolling windows hierarchically: 7d also clears 5h, and 30d clears all child windows',
          revoke: 'Revoke',
