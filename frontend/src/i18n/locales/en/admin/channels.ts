export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        clinePassEndpointHint: 'Use the current service with a local ClinePass group key for end-to-end checks. Use https://api.cline.bot/api/v1 only for direct upstream checks.',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Enter API Key',
