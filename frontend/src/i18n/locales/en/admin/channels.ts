export default {
    ...
    channelMonitor: {
      ...
      groupRequired: 'Please select a local group',
      endpointRequired: 'Please enter an external endpoint',
      apiKeyRequired: 'Please enter an external API Key',
      ...
      form: {
        ...
        targetType: 'Monitor Target',
        targetLocal: 'Local',
        targetExternal: 'External',
        group: 'Local Group',
        groupPlaceholder: 'Select a group to monitor',
        provider: 'Platform',
        ...
        clinePassAPIKeyHint: 'Enter the API Key issued by the external ClinePass service.',
        openRouterAPIKeyHint: 'Enter the API Key issued by the external OpenRouter service.',
        primaryModel: 'Primary Model',
