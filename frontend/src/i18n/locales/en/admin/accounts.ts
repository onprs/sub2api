export default {
    accounts: {
      ...
      firstOutputFailoverCooldown: 'First Output Timeout Cooldown (minutes)',
      firstOutputFailoverCooldownPlaceholder: 'Leave empty for no immediate cooldown',
      firstOutputFailoverCooldownHint: 'After the budget expires, subsequent requests skip this account until the cooldown ends.',
      expiresAt: 'Expires At',
