export default {
    accounts: {
      ...
      firstOutputFailoverTimeout: 'First Output Failover Budget (seconds)',
      firstOutputFailoverTimeoutPlaceholder: 'Leave empty to disable',
      firstOutputFailoverTimeoutHint: 'Applies only to this OpenAI API key. A timeout before valid output switches to the next account.',
      firstOutputFailoverCooldown: 'Account Failover Cooldown (minutes)',
      firstOutputFailoverCooldownPlaceholder: 'Leave empty for no immediate cooldown',
      firstOutputFailoverCooldownHint: 'After the first-output budget expires or upstream returns 502/503/504, subsequent requests skip this account until the cooldown ends.',
      expiresAt: 'Expires At',
      ...
      upstream: {
        ...
        baseUrlHint: 'Compatible upstream gateway address, e.g. https://gateway.example.com/antigravity',
