export default {
    accounts: {
      ...
      tempUnschedulable: {
        ...
        bulkReplaceHint: 'Bulk enable replaces the existing rules on all selected accounts with the rules below.',
        bulkDisableHint: 'Bulk disable turns off this feature and clears existing rules on all selected accounts.',
        moveUp: 'Move rule up',
