export default {
  ...
  keys: {
    ...
    routing: {
      ...
      stability: 'Stability',
      healthWindow: 'Last {minutes} min',
      healthWindowDays: 'Last {days} days',
      refreshHealth: 'Refresh channel monitor status',
      statusHint: 'Latest primary-model check from the matching local channel monitor',
      latencyHint: '7-day average primary-model response latency from the matching local channel monitor',
      stabilityHint: '7-day primary-model availability from the matching local channel monitor; unavailable when no monitor matches',
      sampleCount: '{count} samples',
      noHealthData: '--',
      healthDetails: '{status} · {samples} samples · last observed {observedAt}',
      healthStatus: {
  ...
  usage: {
    ...
    cacheWriteInferredHint: 'Upstream omitted cache-write usage; billed using the group inference rule',
