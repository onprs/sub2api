export default {
  ...
  keys: {
    ...
    routing: {
      ...
      refreshHealth: 'Refresh group status',
      statusHint: 'Current health based on the latest result and stability in the window',
      latencyHint: 'Time to first token for streams; upstream response time for non-streaming requests',
      stabilityHint: 'Successful dynamic routing requests as a share of all requests in the window',
