export default {
  ...
  payment: {
    ...
    quotaWindows: {
      ...
      thirtyDay: '30 days',
      thirtyDayShort: '30d',
      expiresFirst: 'The quota window that expires first is shown first'
    },
    planCard: {
      rate: 'Rate',
      peakRate: 'Peak Rate',
    ...
    admin: {
      ...
      auditActions: {
        AFFILIATE_REBATE_APPLIED: 'Affiliate rebate applied',
        AFFILIATE_REBATE_FAILED: 'Affiliate rebate failed',
        AFFILIATE_REBATE_SKIPPED: 'Affiliate rebate skipped',
        ...
        PAYMENT_AFTER_EXPIRY: 'Payment received after expiry',
        PAYMENT_AMOUNT_MISMATCH: 'Payment amount mismatch',
        PAYMENT_INVALID_AMOUNT: 'Invalid payment amount',
        PAYMENT_PROVIDER_METADATA_MISMATCH: 'Payment provider metadata mismatch',
        PAYMENT_PROVIDER_MISMATCH: 'Payment provider mismatch',
        RECHARGE_RETRY: 'Recharge retried',
        RECHARGE_SUCCESS: 'Recharge succeeded',
        REFUND_FAILED: 'Refund failed',
        REFUND_GATEWAY_FAILED: 'Refund gateway failed',
        REFUND_NO_TRADE_NO: 'Refund missing trade number',
        REFUND_PENDING: 'Refund pending',
        REFUND_PROVIDER_METADATA_MISMATCH: 'Refund provider metadata mismatch',
        REFUND_QUERY_PENDING: 'Refund query pending',
        REFUND_REQUESTED: 'Refund requested',
        REFUND_ROLLBACK_FAILED: 'Refund rollback failed',
        REFUND_SUCCESS: 'Refund succeeded',
        SUBSCRIPTION_ASSIGNED: 'Subscription assigned',
        SUBSCRIPTION_SUCCESS: 'Subscription fulfilled'
      },
      operator: 'Operator',
      ...
      stock: 'Stock',
      stockHint: 'Empty = unlimited stock, 0 = sold out.',
