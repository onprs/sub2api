export default {
  ...
  keys: {
    ...
    routing: {
      ...
      latency: '响应延迟',
      stability: '稳定性',
      healthWindow: '近 {minutes} 分钟',
      healthWindowDays: '近 {days} 天',
      refreshHealth: '刷新渠道监控状态',
      statusHint: '对应本站渠道监控主模型的最近一次检测状态',
      latencyHint: '对应本站渠道监控主模型近 7 天的平均响应耗时',
      stabilityHint: '对应本站渠道监控主模型近 7 天的可用率；无匹配监控时暂无数据',
      sampleCount: '{count} 次',
      noHealthData: '--',
      healthDetails: '{status} · {samples} 次样本 · 最近 {observedAt}',
      healthStatus: {
        operational: '正常',
        degraded: '波动',
        failed: '异常',
