export default {
    ...
    channelMonitor: {
      ...
      groupRequired: '请选择本站分组',
      endpointRequired: '请输入外站上游地址',
      apiKeyRequired: '请输入外站 API Key',
      ...
      form: {
        ...
        clinePassAPIKeyHint: '填写该外站签发的 ClinePass API Key。',
        openRouterAPIKeyHint: '填写该外站签发的 OpenRouter API Key。',
        primaryModel: '主模型',
