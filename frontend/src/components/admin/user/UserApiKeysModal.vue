            ...
            <div class="flex items-center gap-1">
              ...
              >
                <GroupBadge
                  ...
                  :dynamic-rate-enabled="routingPrimaryGroup(key)!.dynamic_rate_enabled"
                  :dynamic-rate-min-multiplier="routingPrimaryGroup(key)!.dynamic_rate_min_multiplier"
                  :dynamic-rate-max-multiplier="routingPrimaryGroup(key)!.dynamic_rate_max_multiplier"
