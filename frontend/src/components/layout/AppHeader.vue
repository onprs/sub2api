...
const modelPlazaEnabled = computed(() =>
  isFeatureFlagEnabled(FeatureFlags.modelPlaza, appStore.cachedPublicSettings),
)
...
const subscriptionFeatureEnabled = computed(() => isFeatureFlagEnabled(FeatureFlags.subscription, appStore.cachedPublicSettings))
