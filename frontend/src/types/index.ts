...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'opencode_go' | 'clinepass' | 'openrouter' | 'commandcode' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'opencode_go' | 'clinepass' | 'openrouter' | 'commandcode' | 'kimi' | 'zhipu' | 'deepseek'
