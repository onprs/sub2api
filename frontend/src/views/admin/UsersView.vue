...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_opencode_go',
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_opencode_go']
