...
// ── 平台限额类型 ──────────────────────────────────────────────────
export type PlatformType = "anthropic" | "openai" | "gemini" | "antigravity" | "grok" | "opencode_go" | "clinepass"
...
const PLATFORMS: PlatformType[] = ["anthropic", "openai", "gemini", "antigravity", "grok", "opencode_go", "clinepass"]
