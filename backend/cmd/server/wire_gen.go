...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, grokQuotaFetcher, openAIQuotaService, usageCache, identityCache, tlsFingerprintProfileService, clinePassClient, httpUpstream, configConfig)
	...
	openCodeGoGatewayHandler := handler.NewOpenCodeGoGatewayHandler(openCodeGoGatewayService, clinePassGatewayService, gatewayService, concurrencyService, billingCacheService, billingEligibilityService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, configConfig)
