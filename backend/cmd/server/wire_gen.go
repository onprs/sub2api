...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, grokQuotaFetcher, openAIQuotaService, usageCache, identityCache, tlsFingerprintProfileService, clinePassClient, openRouterClient, httpUpstream, configConfig)
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, clinePassClient, openRouterClient)
	...
	openCodeGoGatewayHandler := handler.NewOpenCodeGoGatewayHandler(openCodeGoGatewayService, clinePassGatewayService, openRouterGatewayService, gatewayService, concurrencyService, billingCacheService, billingEligibilityService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, configConfig)
