...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelService := service.NewChannelServiceWithCachePubSub(channelRepository, groupRepository, apiKeyAuthCacheInvalidator, pricingService, billingService, channelCachePubSub)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, clinePassClient, openRouterClient, commandCodeClient, openAIGatewayService, settingService, pluginManager)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, gatewayService, pluginManager, concurrencyService, billingCacheService, billingEligibilityService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator)
