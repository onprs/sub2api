...
func TestChannelMonitorGrokProviderMigration(t *testing.T) {
	...
	require.Contains(t, sql, "CHECK (provider IN ('openai', 'anthropic', 'gemini', 'grok', 'opencode_go', 'clinepass', 'openrouter', 'commandcode', 'antigravity_claude', 'antigravity_gemini'))")
