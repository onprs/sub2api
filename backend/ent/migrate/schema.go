...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "first_output_failover_timeout_seconds", Type: field.TypeInt, Nullable: true},
		{Name: "first_output_failover_cooldown_minutes", Type: field.TypeInt, Nullable: true},
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "opencode_go", "clinepass", "antigravity_claude", "antigravity_gemini"}},
