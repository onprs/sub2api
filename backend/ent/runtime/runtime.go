...
func init() {
	...
	// apikeyDescRoutingPlatform is the schema descriptor for routing_platform field.
	apikeyDescRoutingPlatform := apikeyFields[4].Descriptor()
	// apikey.DefaultRoutingPlatform holds the default value on creation for the routing_platform field.
	apikey.DefaultRoutingPlatform = apikeyDescRoutingPlatform.Default.(string)
	// apikey.RoutingPlatformValidator is a validator for the "routing_platform" field. It is called by the builders before save.
	apikey.RoutingPlatformValidator = apikeyDescRoutingPlatform.Validators[0].(func(string) error)
	// apikeyDescRoutingStrategy is the schema descriptor for routing_strategy field.
	apikeyDescRoutingStrategy := apikeyFields[5].Descriptor()
	...
	channelmonitorDescEndpoint := channelmonitorFields[7].Descriptor()
	// channelmonitor.DefaultEndpoint holds the default value on creation for the endpoint field.
	channelmonitor.DefaultEndpoint = channelmonitorDescEndpoint.Default.(string)
	...
	channelmonitorDescAPIKeyEncrypted := channelmonitorFields[8].Descriptor()
	// channelmonitor.DefaultAPIKeyEncrypted holds the default value on creation for the api_key_encrypted field.
	channelmonitor.DefaultAPIKeyEncrypted = channelmonitorDescAPIKeyEncrypted.Default.(string)
	// channelmonitorDescPrimaryModel is the schema descriptor for primary_model field.
	channelmonitorDescPrimaryModel := channelmonitorFields[9].Descriptor()
	...
	channelmonitorDescExtraModels := channelmonitorFields[10].Descriptor()
	...
	channelmonitorDescGroupName := channelmonitorFields[11].Descriptor()
	...
	groupDescDynamicRateEnabled := groupFields[3].Descriptor()
	...
	// groupDescDynamicRateMaxMultiplier is the schema descriptor for dynamic_rate_max_multiplier field.
	groupDescDynamicRateMaxMultiplier := groupFields[4].Descriptor()
	// group.DefaultDynamicRateMaxMultiplier holds the default value on creation for the dynamic_rate_max_multiplier field.
	group.DefaultDynamicRateMaxMultiplier = groupDescDynamicRateMaxMultiplier.Default.(float64)
	// groupDescDynamicRateMinMultiplier is the schema descriptor for dynamic_rate_min_multiplier field.
	groupDescDynamicRateMinMultiplier := groupFields[5].Descriptor()
	// group.DefaultDynamicRateMinMultiplier holds the default value on creation for the dynamic_rate_min_multiplier field.
	group.DefaultDynamicRateMinMultiplier = groupDescDynamicRateMinMultiplier.Default.(float64)
	// groupDescDynamicRateTargetTokens is the schema descriptor for dynamic_rate_target_tokens field.
	groupDescDynamicRateTargetTokens := groupFields[6].Descriptor()
	// group.DefaultDynamicRateTargetTokens holds the default value on creation for the dynamic_rate_target_tokens field.
	group.DefaultDynamicRateTargetTokens = groupDescDynamicRateTargetTokens.Default.(int64)
	// groupDescDynamicRateWindowMinutes is the schema descriptor for dynamic_rate_window_minutes field.
	groupDescDynamicRateWindowMinutes := groupFields[7].Descriptor()
	// group.DefaultDynamicRateWindowMinutes holds the default value on creation for the dynamic_rate_window_minutes field.
	group.DefaultDynamicRateWindowMinutes = groupDescDynamicRateWindowMinutes.Default.(int)
	// groupDescPeakRateEnabled is the schema descriptor for peak_rate_enabled field.
	groupDescPeakRateEnabled := groupFields[8].Descriptor()
	...
	groupDescPeakStart := groupFields[9].Descriptor()
	...
	groupDescPeakEnd := groupFields[10].Descriptor()
	...
	groupDescPeakRateMultiplier := groupFields[11].Descriptor()
	...
	groupDescIsExclusive := groupFields[12].Descriptor()
	...
	groupDescSearchPricePer1k := groupFields[37].Descriptor()
	...
	groupDescAudioRealtimePricePerMin := groupFields[38].Descriptor()
	...
	groupDescAudioTtsPricePerMillionChars := groupFields[39].Descriptor()
	...
	groupDescAudioSttPricePerHour := groupFields[40].Descriptor()
	...
	groupDescInferGpt56CacheWrite := groupFields[61].Descriptor()
	...
	groupDescInferGpt56CacheWriteMinTokens := groupFields[62].Descriptor()
	...
	// paymentorderDescSubscriptionPlanPrice is the schema descriptor for subscription_plan_price field.
	paymentorderDescSubscriptionPlanPrice := paymentorderFields[19].Descriptor()
	// paymentorder.SubscriptionPlanPriceValidator is a validator for the "subscription_plan_price" field. It is called by the builders before save.
	paymentorder.SubscriptionPlanPriceValidator = paymentorderDescSubscriptionPlanPrice.Validators[0].(func(float64) error)
	// paymentorderDescSubscriptionRenewalDiscountPercent is the schema descriptor for subscription_renewal_discount_percent field.
	paymentorderDescSubscriptionRenewalDiscountPercent := paymentorderFields[20].Descriptor()
	// paymentorder.SubscriptionRenewalDiscountPercentValidator is a validator for the "subscription_renewal_discount_percent" field. It is called by the builders before save.
	paymentorder.SubscriptionRenewalDiscountPercentValidator = paymentorderDescSubscriptionRenewalDiscountPercent.Validators[0].(func(float64) error)
	// paymentorderDescSubscriptionQuotaSnapshotVersion is the schema descriptor for subscription_quota_snapshot_version field.
	paymentorderDescSubscriptionQuotaSnapshotVersion := paymentorderFields[21].Descriptor()
	// paymentorder.DefaultSubscriptionQuotaSnapshotVersion holds the default value on creation for the subscription_quota_snapshot_version field.
	paymentorder.DefaultSubscriptionQuotaSnapshotVersion = paymentorderDescSubscriptionQuotaSnapshotVersion.Default.(int)
	// paymentorderDescSubscriptionFiveHourLimitUsd is the schema descriptor for subscription_five_hour_limit_usd field.
	paymentorderDescSubscriptionFiveHourLimitUsd := paymentorderFields[22].Descriptor()
	// paymentorder.SubscriptionFiveHourLimitUsdValidator is a validator for the "subscription_five_hour_limit_usd" field. It is called by the builders before save.
	paymentorder.SubscriptionFiveHourLimitUsdValidator = paymentorderDescSubscriptionFiveHourLimitUsd.Validators[0].(func(float64) error)
	// paymentorderDescSubscriptionSevenDayLimitUsd is the schema descriptor for subscription_seven_day_limit_usd field.
	paymentorderDescSubscriptionSevenDayLimitUsd := paymentorderFields[23].Descriptor()
	// paymentorder.SubscriptionSevenDayLimitUsdValidator is a validator for the "subscription_seven_day_limit_usd" field. It is called by the builders before save.
	paymentorder.SubscriptionSevenDayLimitUsdValidator = paymentorderDescSubscriptionSevenDayLimitUsd.Validators[0].(func(float64) error)
	// paymentorderDescSubscriptionThirtyDayLimitUsd is the schema descriptor for subscription_thirty_day_limit_usd field.
	paymentorderDescSubscriptionThirtyDayLimitUsd := paymentorderFields[24].Descriptor()
	// paymentorder.SubscriptionThirtyDayLimitUsdValidator is a validator for the "subscription_thirty_day_limit_usd" field. It is called by the builders before save.
	paymentorder.SubscriptionThirtyDayLimitUsdValidator = paymentorderDescSubscriptionThirtyDayLimitUsd.Validators[0].(func(float64) error)
	...
	// redeemcodeDescSubscriptionQuotaSnapshotVersion is the schema descriptor for subscription_quota_snapshot_version field.
	redeemcodeDescSubscriptionQuotaSnapshotVersion := redeemcodeFields[12].Descriptor()
	// redeemcode.DefaultSubscriptionQuotaSnapshotVersion holds the default value on creation for the subscription_quota_snapshot_version field.
	redeemcode.DefaultSubscriptionQuotaSnapshotVersion = redeemcodeDescSubscriptionQuotaSnapshotVersion.Default.(int)
	// redeemcodeDescFiveHourLimitUsd is the schema descriptor for five_hour_limit_usd field.
	redeemcodeDescFiveHourLimitUsd := redeemcodeFields[13].Descriptor()
	// redeemcode.FiveHourLimitUsdValidator is a validator for the "five_hour_limit_usd" field. It is called by the builders before save.
	redeemcode.FiveHourLimitUsdValidator = redeemcodeDescFiveHourLimitUsd.Validators[0].(func(float64) error)
	// redeemcodeDescSevenDayLimitUsd is the schema descriptor for seven_day_limit_usd field.
	redeemcodeDescSevenDayLimitUsd := redeemcodeFields[14].Descriptor()
	// redeemcode.SevenDayLimitUsdValidator is a validator for the "seven_day_limit_usd" field. It is called by the builders before save.
	redeemcode.SevenDayLimitUsdValidator = redeemcodeDescSevenDayLimitUsd.Validators[0].(func(float64) error)
	// redeemcodeDescThirtyDayLimitUsd is the schema descriptor for thirty_day_limit_usd field.
	redeemcodeDescThirtyDayLimitUsd := redeemcodeFields[15].Descriptor()
	// redeemcode.ThirtyDayLimitUsdValidator is a validator for the "thirty_day_limit_usd" field. It is called by the builders before save.
	redeemcode.ThirtyDayLimitUsdValidator = redeemcodeDescThirtyDayLimitUsd.Validators[0].(func(float64) error)
	...
	// subscriptionplanDescRenewalDiscountPercent is the schema descriptor for renewal_discount_percent field.
	subscriptionplanDescRenewalDiscountPercent := subscriptionplanFields[5].Descriptor()
	// subscriptionplan.RenewalDiscountPercentValidator is a validator for the "renewal_discount_percent" field. It is called by the builders before save.
	subscriptionplan.RenewalDiscountPercentValidator = subscriptionplanDescRenewalDiscountPercent.Validators[0].(func(float64) error)
	// subscriptionplanDescFiveHourLimitUsd is the schema descriptor for five_hour_limit_usd field.
	subscriptionplanDescFiveHourLimitUsd := subscriptionplanFields[6].Descriptor()
	// subscriptionplan.FiveHourLimitUsdValidator is a validator for the "five_hour_limit_usd" field. It is called by the builders before save.
	subscriptionplan.FiveHourLimitUsdValidator = subscriptionplanDescFiveHourLimitUsd.Validators[0].(func(float64) error)
	// subscriptionplanDescSevenDayLimitUsd is the schema descriptor for seven_day_limit_usd field.
	subscriptionplanDescSevenDayLimitUsd := subscriptionplanFields[7].Descriptor()
	// subscriptionplan.SevenDayLimitUsdValidator is a validator for the "seven_day_limit_usd" field. It is called by the builders before save.
	subscriptionplan.SevenDayLimitUsdValidator = subscriptionplanDescSevenDayLimitUsd.Validators[0].(func(float64) error)
	// subscriptionplanDescThirtyDayLimitUsd is the schema descriptor for thirty_day_limit_usd field.
	subscriptionplanDescThirtyDayLimitUsd := subscriptionplanFields[8].Descriptor()
	// subscriptionplan.ThirtyDayLimitUsdValidator is a validator for the "thirty_day_limit_usd" field. It is called by the builders before save.
	subscriptionplan.ThirtyDayLimitUsdValidator = subscriptionplanDescThirtyDayLimitUsd.Validators[0].(func(float64) error)
	// subscriptionplanDescStock is the schema descriptor for stock field.
	subscriptionplanDescStock := subscriptionplanFields[9].Descriptor()
	// subscriptionplan.StockValidator is a validator for the "stock" field. It is called by the builders before save.
	subscriptionplan.StockValidator = subscriptionplanDescStock.Validators[0].(func(int) error)
	...
	ticketDescTicketNo := ticketFields[0].Descriptor()
	// ticket.TicketNoValidator is a validator for the "ticket_no" field. It is called by the builders before save.
	ticket.TicketNoValidator = func() func(string) error {
		validators := ticketDescTicketNo.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(ticket_no string) error {
			for _, fn := range fns {
				if err := fn(ticket_no); err != nil {
					return err
				}
			}
			return nil
	...
	// ticketDescRequesterEmail is the schema descriptor for requester_email field.
	ticketDescRequesterEmail := ticketFields[2].Descriptor()
	// ticket.DefaultRequesterEmail holds the default value on creation for the requester_email field.
	ticket.DefaultRequesterEmail = ticketDescRequesterEmail.Default.(string)
	// ticket.RequesterEmailValidator is a validator for the "requester_email" field. It is called by the builders before save.
	ticket.RequesterEmailValidator = ticketDescRequesterEmail.Validators[0].(func(string) error)
	// ticketDescRequesterUsername is the schema descriptor for requester_username field.
	ticketDescRequesterUsername := ticketFields[3].Descriptor()
	// ticket.DefaultRequesterUsername holds the default value on creation for the requester_username field.
	ticket.DefaultRequesterUsername = ticketDescRequesterUsername.Default.(string)
	// ticket.RequesterUsernameValidator is a validator for the "requester_username" field. It is called by the builders before save.
	ticket.RequesterUsernameValidator = ticketDescRequesterUsername.Validators[0].(func(string) error)
	// ticketDescSubject is the schema descriptor for subject field.
	ticketDescSubject := ticketFields[4].Descriptor()
	...
	ticketDescCategory := ticketFields[5].Descriptor()
	// ticket.CategoryValidator is a validator for the "category" field. It is called by the builders before save.
	ticket.CategoryValidator = func() func(string) error {
		validators := ticketDescCategory.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketDescImpact is the schema descriptor for impact field.
	ticketDescImpact := ticketFields[6].Descriptor()
	// ticket.ImpactValidator is a validator for the "impact" field. It is called by the builders before save.
	ticket.ImpactValidator = func() func(string) error {
		validators := ticketDescImpact.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(impact string) error {
			for _, fn := range fns {
	...
	ticketDescPriority := ticketFields[7].Descriptor()
	...
	ticket.PriorityValidator = func() func(string) error {
		validators := ticketDescPriority.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	ticket.StatusValidator = func() func(string) error {
		validators := ticketDescStatus.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	ticketDescRequestID := ticketFields[10].Descriptor()
	// ticket.DefaultRequestID holds the default value on creation for the request_id field.
	ticket.DefaultRequestID = ticketDescRequestID.Default.(string)
	...
	// ticketDescAPIKeyName is the schema descriptor for api_key_name field.
	ticketDescAPIKeyName := ticketFields[13].Descriptor()
	// ticket.DefaultAPIKeyName holds the default value on creation for the api_key_name field.
	ticket.DefaultAPIKeyName = ticketDescAPIKeyName.Default.(string)
	// ticket.APIKeyNameValidator is a validator for the "api_key_name" field. It is called by the builders before save.
	ticket.APIKeyNameValidator = ticketDescAPIKeyName.Validators[0].(func(string) error)
	// ticketDescPaymentOrderNo is the schema descriptor for payment_order_no field.
	ticketDescPaymentOrderNo := ticketFields[15].Descriptor()
	// ticket.DefaultPaymentOrderNo holds the default value on creation for the payment_order_no field.
	ticket.DefaultPaymentOrderNo = ticketDescPaymentOrderNo.Default.(string)
	// ticket.PaymentOrderNoValidator is a validator for the "payment_order_no" field. It is called by the builders before save.
	ticket.PaymentOrderNoValidator = ticketDescPaymentOrderNo.Validators[0].(func(string) error)
	// ticketDescSubscriptionName is the schema descriptor for subscription_name field.
	ticketDescSubscriptionName := ticketFields[17].Descriptor()
	// ticket.DefaultSubscriptionName holds the default value on creation for the subscription_name field.
	ticket.DefaultSubscriptionName = ticketDescSubscriptionName.Default.(string)
	// ticket.SubscriptionNameValidator is a validator for the "subscription_name" field. It is called by the builders before save.
	ticket.SubscriptionNameValidator = ticketDescSubscriptionName.Validators[0].(func(string) error)
	// ticketDescLastPublicMessageAt is the schema descriptor for last_public_message_at field.
	ticketDescLastPublicMessageAt := ticketFields[18].Descriptor()
	// ticket.DefaultLastPublicMessageAt holds the default value on creation for the last_public_message_at field.
	ticket.DefaultLastPublicMessageAt = ticketDescLastPublicMessageAt.Default.(func() time.Time)
	// ticketDescLastActivityAt is the schema descriptor for last_activity_at field.
	ticketDescLastActivityAt := ticketFields[19].Descriptor()
	// ticket.DefaultLastActivityAt holds the default value on creation for the last_activity_at field.
	ticket.DefaultLastActivityAt = ticketDescLastActivityAt.Default.(func() time.Time)
	// ticketDescUserNotificationSeq is the schema descriptor for user_notification_seq field.
	ticketDescUserNotificationSeq := ticketFields[21].Descriptor()
	// ticket.DefaultUserNotificationSeq holds the default value on creation for the user_notification_seq field.
	ticket.DefaultUserNotificationSeq = ticketDescUserNotificationSeq.Default.(int64)
	// ticket.UserNotificationSeqValidator is a validator for the "user_notification_seq" field. It is called by the builders before save.
	ticket.UserNotificationSeqValidator = ticketDescUserNotificationSeq.Validators[0].(func(int64) error)
	// ticketDescUserLastReadSeq is the schema descriptor for user_last_read_seq field.
	ticketDescUserLastReadSeq := ticketFields[22].Descriptor()
	// ticket.DefaultUserLastReadSeq holds the default value on creation for the user_last_read_seq field.
	ticket.DefaultUserLastReadSeq = ticketDescUserLastReadSeq.Default.(int64)
	// ticket.UserLastReadSeqValidator is a validator for the "user_last_read_seq" field. It is called by the builders before save.
	ticket.UserLastReadSeqValidator = ticketDescUserLastReadSeq.Validators[0].(func(int64) error)
	// ticketDescVersion is the schema descriptor for version field.
	ticketDescVersion := ticketFields[26].Descriptor()
	// ticket.DefaultVersion holds the default value on creation for the version field.
	ticket.DefaultVersion = ticketDescVersion.Default.(int64)
	// ticket.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	ticket.VersionValidator = ticketDescVersion.Validators[0].(func(int64) error)
	ticketattachmentFields := schema.TicketAttachment{}.Fields()
	_ = ticketattachmentFields
	// ticketattachmentDescUploadToken is the schema descriptor for upload_token field.
	ticketattachmentDescUploadToken := ticketattachmentFields[0].Descriptor()
	// ticketattachment.UploadTokenValidator is a validator for the "upload_token" field. It is called by the builders before save.
	ticketattachment.UploadTokenValidator = func() func(string) error {
		validators := ticketattachmentDescUploadToken.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(upload_token string) error {
			for _, fn := range fns {
				if err := fn(upload_token); err != nil {
					return err
				}
			}
			return nil
	...
	// ticketattachmentDescUploaderRole is the schema descriptor for uploader_role field.
	ticketattachmentDescUploaderRole := ticketattachmentFields[2].Descriptor()
	// ticketattachment.UploaderRoleValidator is a validator for the "uploader_role" field. It is called by the builders before save.
	ticketattachment.UploaderRoleValidator = func() func(string) error {
		validators := ticketattachmentDescUploaderRole.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(uploader_role string) error {
			for _, fn := range fns {
				if err := fn(uploader_role); err != nil {
					return err
				}
			}
			return nil
	...
	// ticketattachmentDescState is the schema descriptor for state field.
	ticketattachmentDescState := ticketattachmentFields[5].Descriptor()
	// ticketattachment.DefaultState holds the default value on creation for the state field.
	ticketattachment.DefaultState = ticketattachmentDescState.Default.(string)
	// ticketattachment.StateValidator is a validator for the "state" field. It is called by the builders before save.
	ticketattachment.StateValidator = func() func(string) error {
		validators := ticketattachmentDescState.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketattachmentDescStorageProvider is the schema descriptor for storage_provider field.
	ticketattachmentDescStorageProvider := ticketattachmentFields[6].Descriptor()
	// ticketattachment.StorageProviderValidator is a validator for the "storage_provider" field. It is called by the builders before save.
	ticketattachment.StorageProviderValidator = func() func(string) error {
		validators := ticketattachmentDescStorageProvider.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(storage_provider string) error {
			for _, fn := range fns {
				if err := fn(storage_provider); err != nil {
					return err
				}
			}
			return nil
	...
	ticketattachmentDescObjectKey := ticketattachmentFields[7].Descriptor()
	...
	ticketattachmentDescOriginalName := ticketattachmentFields[8].Descriptor()
	...
	ticketattachment.OriginalNameValidator = func() func(string) error {
		validators := ticketattachmentDescOriginalName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	ticketattachmentDescContentType := ticketattachmentFields[9].Descriptor()
	// ticketattachment.ContentTypeValidator is a validator for the "content_type" field. It is called by the builders before save.
	ticketattachment.ContentTypeValidator = func() func(string) error {
		validators := ticketattachmentDescContentType.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketattachmentDescByteSize is the schema descriptor for byte_size field.
	ticketattachmentDescByteSize := ticketattachmentFields[10].Descriptor()
	// ticketattachment.ByteSizeValidator is a validator for the "byte_size" field. It is called by the builders before save.
	ticketattachment.ByteSizeValidator = ticketattachmentDescByteSize.Validators[0].(func(int64) error)
	// ticketattachmentDescSha256 is the schema descriptor for sha256 field.
	ticketattachmentDescSha256 := ticketattachmentFields[11].Descriptor()
	// ticketattachment.Sha256Validator is a validator for the "sha256" field. It is called by the builders before save.
	ticketattachment.Sha256Validator = func() func(string) error {
		validators := ticketattachmentDescSha256.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	ticketattachmentDescCreatedAt := ticketattachmentFields[13].Descriptor()
	...
	_ = ticketeventFields
	// ticketeventDescActorRole is the schema descriptor for actor_role field.
	ticketeventDescActorRole := ticketeventFields[2].Descriptor()
	// ticketevent.ActorRoleValidator is a validator for the "actor_role" field. It is called by the builders before save.
	ticketevent.ActorRoleValidator = func() func(string) error {
		validators := ticketeventDescActorRole.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketeventDescEventType is the schema descriptor for event_type field.
	ticketeventDescEventType := ticketeventFields[3].Descriptor()
	// ticketevent.EventTypeValidator is a validator for the "event_type" field. It is called by the builders before save.
	ticketevent.EventTypeValidator = func() func(string) error {
		validators := ticketeventDescEventType.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketeventDescFromStatus is the schema descriptor for from_status field.
	ticketeventDescFromStatus := ticketeventFields[4].Descriptor()
	// ticketevent.FromStatusValidator is a validator for the "from_status" field. It is called by the builders before save.
	ticketevent.FromStatusValidator = func() func(string) error {
		validators := ticketeventDescFromStatus.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(from_status string) error {
			for _, fn := range fns {
				if err := fn(from_status); err != nil {
					return err
				}
			}
			return nil
	...
	// ticketeventDescToStatus is the schema descriptor for to_status field.
	ticketeventDescToStatus := ticketeventFields[5].Descriptor()
	// ticketevent.ToStatusValidator is a validator for the "to_status" field. It is called by the builders before save.
	ticketevent.ToStatusValidator = func() func(string) error {
		validators := ticketeventDescToStatus.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketeventDescPayload is the schema descriptor for payload field.
	ticketeventDescPayload := ticketeventFields[6].Descriptor()
	// ticketevent.DefaultPayload holds the default value on creation for the payload field.
	ticketevent.DefaultPayload = ticketeventDescPayload.Default.(func() map[string]interface{})
	// ticketeventDescVisibility is the schema descriptor for visibility field.
	ticketeventDescVisibility := ticketeventFields[7].Descriptor()
	// ticketevent.VisibilityValidator is a validator for the "visibility" field. It is called by the builders before save.
	ticketevent.VisibilityValidator = func() func(string) error {
		validators := ticketeventDescVisibility.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	ticketeventDescCreatedAt := ticketeventFields[8].Descriptor()
	...
	ticketmessage.AuthorRoleValidator = func() func(string) error {
		validators := ticketmessageDescAuthorRole.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketmessageDescVisibility is the schema descriptor for visibility field.
	ticketmessageDescVisibility := ticketmessageFields[3].Descriptor()
	// ticketmessage.VisibilityValidator is a validator for the "visibility" field. It is called by the builders before save.
	ticketmessage.VisibilityValidator = func() func(string) error {
		validators := ticketmessageDescVisibility.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// ticketmessageDescAuthorName is the schema descriptor for author_name field.
	ticketmessageDescAuthorName := ticketmessageFields[4].Descriptor()
	// ticketmessage.DefaultAuthorName holds the default value on creation for the author_name field.
	ticketmessage.DefaultAuthorName = ticketmessageDescAuthorName.Default.(string)
	// ticketmessage.AuthorNameValidator is a validator for the "author_name" field. It is called by the builders before save.
	ticketmessage.AuthorNameValidator = ticketmessageDescAuthorName.Validators[0].(func(string) error)
	// ticketmessageDescBody is the schema descriptor for body field.
	ticketmessageDescBody := ticketmessageFields[5].Descriptor()
	// ticketmessage.BodyValidator is a validator for the "body" field. It is called by the builders before save.
	ticketmessage.BodyValidator = func() func(string) error {
		validators := ticketmessageDescBody.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	ticketmessageDescCreatedAt := ticketmessageFields[6].Descriptor()
	...
	// usagelogDescCacheWriteInferred is the schema descriptor for cache_write_inferred field.
	usagelogDescCacheWriteInferred := usagelogFields[21].Descriptor()
	// usagelog.DefaultCacheWriteInferred holds the default value on creation for the cache_write_inferred field.
	usagelog.DefaultCacheWriteInferred = usagelogDescCacheWriteInferred.Default.(bool)
	...
	// usersubscriptionDescFiveHourLimitUsd is the schema descriptor for five_hour_limit_usd field.
	usersubscriptionDescFiveHourLimitUsd := usersubscriptionFields[6].Descriptor()
	// usersubscription.FiveHourLimitUsdValidator is a validator for the "five_hour_limit_usd" field. It is called by the builders before save.
	usersubscription.FiveHourLimitUsdValidator = usersubscriptionDescFiveHourLimitUsd.Validators[0].(func(float64) error)
	// usersubscriptionDescSevenDayLimitUsd is the schema descriptor for seven_day_limit_usd field.
	usersubscriptionDescSevenDayLimitUsd := usersubscriptionFields[7].Descriptor()
	// usersubscription.SevenDayLimitUsdValidator is a validator for the "seven_day_limit_usd" field. It is called by the builders before save.
	usersubscription.SevenDayLimitUsdValidator = usersubscriptionDescSevenDayLimitUsd.Validators[0].(func(float64) error)
	// usersubscriptionDescThirtyDayLimitUsd is the schema descriptor for thirty_day_limit_usd field.
	usersubscriptionDescThirtyDayLimitUsd := usersubscriptionFields[8].Descriptor()
	// usersubscription.ThirtyDayLimitUsdValidator is a validator for the "thirty_day_limit_usd" field. It is called by the builders before save.
	usersubscription.ThirtyDayLimitUsdValidator = usersubscriptionDescThirtyDayLimitUsd.Validators[0].(func(float64) error)
	// usersubscriptionDescDailyUsageUsd is the schema descriptor for daily_usage_usd field.
	usersubscriptionDescDailyUsageUsd := usersubscriptionFields[15].Descriptor()
	...
	usersubscriptionDescWeeklyUsageUsd := usersubscriptionFields[16].Descriptor()
	...
	usersubscriptionDescMonthlyUsageUsd := usersubscriptionFields[17].Descriptor()
	...
	usersubscriptionDescFiveHourUsageUsd := usersubscriptionFields[18].Descriptor()
	...
	// usersubscriptionDescSevenDayUsageUsd is the schema descriptor for seven_day_usage_usd field.
	usersubscriptionDescSevenDayUsageUsd := usersubscriptionFields[19].Descriptor()
	// usersubscription.DefaultSevenDayUsageUsd holds the default value on creation for the seven_day_usage_usd field.
	usersubscription.DefaultSevenDayUsageUsd = usersubscriptionDescSevenDayUsageUsd.Default.(float64)
	// usersubscriptionDescThirtyDayUsageUsd is the schema descriptor for thirty_day_usage_usd field.
	usersubscriptionDescThirtyDayUsageUsd := usersubscriptionFields[20].Descriptor()
	// usersubscription.DefaultThirtyDayUsageUsd holds the default value on creation for the thirty_day_usage_usd field.
	usersubscription.DefaultThirtyDayUsageUsd = usersubscriptionDescThirtyDayUsageUsd.Default.(float64)
	// usersubscriptionDescAssignedAt is the schema descriptor for assigned_at field.
	usersubscriptionDescAssignedAt := usersubscriptionFields[22].Descriptor()
