...
func init() {
	...
	groupDescInferGpt56CacheWrite := groupFields[45].Descriptor()
	...
	groupDescInferGpt56CacheWriteMinTokens := groupFields[46].Descriptor()
	...
	usagelogDescCacheWriteInferred := usagelogFields[19].Descriptor()
