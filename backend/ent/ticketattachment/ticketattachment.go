...
const (
	...
	// FieldUploaderRole holds the string denoting the uploader_role field in the database.
	FieldUploaderRole = "uploader_role"
	...
	MessageTable = "ticket_attachments"
	// MessageInverseTable is the table name for the TicketMessage entity.
	// It exists in this package in order to avoid circular dependency with the "ticketmessage" package.
	MessageInverseTable = "ticket_messages"
...
var (
	// UploadTokenValidator is a validator for the "upload_token" field. It is called by the builders before save.
	UploadTokenValidator func(string) error
	// UploaderRoleValidator is a validator for the "uploader_role" field. It is called by the builders before save.
	UploaderRoleValidator func(string) error
...
// ByUploaderRole orders the results by the uploader_role field.
func ByUploaderRole(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldUploaderRole, opts...).ToFunc()
}
