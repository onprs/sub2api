...
func ProviderValidator(pr Provider) error {
	switch pr {
	case ProviderOpenai, ProviderAnthropic, ProviderGemini, ProviderGrok, ProviderOpencode, ProviderClinepass, ProviderOpenrouter, ProviderCommandcode, ProviderAntigravity, ProviderAntigravityClaude, ProviderAntigravityGemini, ProviderKimi, ProviderZhipu, ProviderDeepseek, ProviderMinimax:
		return nil
	default:
