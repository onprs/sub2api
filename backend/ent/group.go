...
type Group struct {
	...
	InferGpt56CacheWrite bool `json:"infer_gpt56_cache_write,omitempty"`
	// 触发 GPT-5.6 缓存写入推断所需的最小未缓存输入 token 数
	InferGpt56CacheWriteMinTokens int `json:"infer_gpt56_cache_write_min_tokens,omitempty"`
...
type GroupEdges struct {
	...
	// RoutingAPIKeys holds the value of the routing_api_keys edge.
	RoutingAPIKeys []*APIKey `json:"routing_api_keys,omitempty"`
	...
	// ChannelMonitors holds the value of the channel_monitors edge.
	ChannelMonitors []*ChannelMonitor `json:"channel_monitors,omitempty"`
...
// RoutingAPIKeysOrErr returns the RoutingAPIKeys value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) RoutingAPIKeysOrErr() ([]*APIKey, error) {
	if e.loadedTypes[1] {
		return e.RoutingAPIKeys, nil
	}
	return nil, &NotLoadedError{edge: "routing_api_keys"}
}
...
// ChannelMonitorsOrErr returns the ChannelMonitors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) ChannelMonitorsOrErr() ([]*ChannelMonitor, error) {
	if e.loadedTypes[5] {
		return e.ChannelMonitors, nil
	}
	return nil, &NotLoadedError{edge: "channel_monitors"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldInferGpt56CacheWrite:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldInferGpt56CacheWrite:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field infer_gpt56_cache_write", values[i])
			} else if value.Valid {
				_m.InferGpt56CacheWrite = value.Bool
			}
		case group.FieldInferGpt56CacheWriteMinTokens:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field infer_gpt56_cache_write_min_tokens", values[i])
			} else if value.Valid {
				_m.InferGpt56CacheWriteMinTokens = int(value.Int64)
			}
...
// QueryRoutingAPIKeys queries the "routing_api_keys" edge of the Group entity.
func (_m *Group) QueryRoutingAPIKeys() *APIKeyQuery {
	return NewGroupClient(_m.config).QueryRoutingAPIKeys(_m)
}
...
// QueryChannelMonitors queries the "channel_monitors" edge of the Group entity.
func (_m *Group) QueryChannelMonitors() *ChannelMonitorQuery {
	return NewGroupClient(_m.config).QueryChannelMonitors(_m)
}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("infer_gpt56_cache_write=")
	builder.WriteString(fmt.Sprintf("%v", _m.InferGpt56CacheWrite))
	builder.WriteString(", ")
	builder.WriteString("infer_gpt56_cache_write_min_tokens=")
	builder.WriteString(fmt.Sprintf("%v", _m.InferGpt56CacheWriteMinTokens))
	builder.WriteString(", ")
