...
func (_q *TicketQuery) QueryRequester() *UserQuery {
...
func (_q *TicketQuery) QueryAssignee() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TicketQuery) QueryEvents() *TicketEventQuery {
...
func (_q *TicketQuery) WithRequester(opts ...func(*UserQuery)) *TicketQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *TicketQuery) WithAssignee(opts ...func(*UserQuery)) *TicketQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TicketQuery) WithEvents(opts ...func(*TicketEventQuery)) *TicketQuery {
	query := (&TicketEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TicketQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Ticket, error) {
	...
	if query := _q.withEvents; query != nil {
		if err := _q.loadEvents(ctx, query, nodes,
			func(n *Ticket) { n.Edges.Events = []*TicketEvent{} },
			func(n *Ticket, e *TicketEvent) { n.Edges.Events = append(n.Edges.Events, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *TicketQuery) loadRequester(ctx context.Context, query *UserQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *User)) error {
...
func (_q *TicketQuery) loadAssignee(ctx context.Context, query *UserQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Ticket)
	for i := range nodes {
...
func (_q *TicketQuery) loadEvents(ctx context.Context, query *TicketEventQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *TicketEvent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Ticket)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ticketevent.FieldTicketID)
	}
