...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.SubscriptionPlan, c.TLSFingerprintProfile, c.Ticket, c.TicketAttachment,
		c.TicketEvent, c.TicketMessage, c.UsageCleanupTask, c.UsageLog, c.User,
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *TicketEventMutation:
		return c.TicketEvent.mutate(ctx, m)
...
// QueryRoutingGroups queries the routing_groups edge of a APIKey.
func (c *APIKeyClient) QueryRoutingGroups(_m *APIKey) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(apikey.Table, apikey.FieldID, id),
			sqlgraph.To(group.Table, group.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, apikey.RoutingGroupsTable, apikey.RoutingGroupsPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryRoutingAPIKeys queries the routing_api_keys edge of a Group.
func (c *GroupClient) QueryRoutingAPIKeys(_m *Group) *APIKeyQuery {
	query := (&APIKeyClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(group.Table, group.FieldID, id),
			sqlgraph.To(apikey.Table, apikey.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, group.RoutingAPIKeysTable, group.RoutingAPIKeysPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QuerySubscriptionPlan queries the subscription_plan edge of a RedeemCode.
func (c *RedeemCodeClient) QuerySubscriptionPlan(_m *RedeemCode) *SubscriptionPlanQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, redeemcode.SubscriptionPlanTable, redeemcode.SubscriptionPlanColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *TicketClient) QueryEvents(_m *Ticket) *TicketEventQuery {
	query := (&TicketEventClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(ticket.Table, ticket.FieldID, id),
...
func (c *TicketClient) QueryAttachments(_m *Ticket) *TicketAttachmentQuery {
...
// UpdateOneID returns an update builder for the given id.
func (c *TicketAttachmentClient) UpdateOneID(id int64) *TicketAttachmentUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *TicketAttachmentClient) DeleteOneID(id int64) *TicketAttachmentDeleteOne {
...
func (c *TicketAttachmentClient) Get(ctx context.Context, id int64) (*TicketAttachment, error) {
	return c.Query().Where(ticketattachment.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TicketAttachmentClient) GetX(ctx context.Context, id int64) *TicketAttachment {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *TicketAttachmentClient) QueryUploader(_m *TicketAttachment) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *TicketAttachmentClient) QueryTicket(_m *TicketAttachment) *TicketQuery {
...
// QueryMessage queries the message edge of a TicketAttachment.
func (c *TicketAttachmentClient) QueryMessage(_m *TicketAttachment) *TicketMessageQuery {
	query := (&TicketMessageClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `ticketevent.Intercept(f(g(h())))`.
func (c *TicketEventClient) Intercept(interceptors ...Interceptor) {
	c.inters.TicketEvent = append(c.inters.TicketEvent, interceptors...)
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *TicketEventClient) MapCreateBulk(slice any, setFunc func(*TicketEventCreate, int)) *TicketEventCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &TicketEventCreateBulk{err: fmt.Errorf("calling to TicketEventClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*TicketEventCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// UpdateOne returns an update builder for the given entity.
func (c *TicketEventClient) UpdateOne(_m *TicketEvent) *TicketEventUpdateOne {
	mutation := newTicketEventMutation(c.config, OpUpdateOne, withTicketEvent(_m))
	return &TicketEventUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *TicketEventClient) UpdateOneID(id int64) *TicketEventUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity.
func (c *TicketEventClient) DeleteOne(_m *TicketEvent) *TicketEventDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *TicketEventClient) DeleteOneID(id int64) *TicketEventDeleteOne {
...
func (c *TicketEventClient) Query() *TicketEventQuery {
	return &TicketEventQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeTicketEvent},
		inters: c.Interceptors(),
	}
}

// Get returns a TicketEvent entity by its id.
func (c *TicketEventClient) Get(ctx context.Context, id int64) (*TicketEvent, error) {
	return c.Query().Where(ticketevent.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TicketEventClient) GetX(ctx context.Context, id int64) *TicketEvent {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *TicketEventClient) QueryTicket(_m *TicketEvent) *TicketQuery {
	query := (&TicketClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryActor queries the actor edge of a TicketEvent.
func (c *TicketEventClient) QueryActor(_m *TicketEvent) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// Interceptors returns the client interceptors.
func (c *TicketEventClient) Interceptors() []Interceptor {
	return c.inters.TicketEvent
}

func (c *TicketEventClient) mutate(ctx context.Context, m *TicketEventMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&TicketEventCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&TicketEventUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&TicketEventUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&TicketEventDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown TicketEvent mutation op: %q", m.Op())
	}
}
...
// QueryAuthor queries the author edge of a TicketMessage.
func (c *TicketMessageClient) QueryAuthor(_m *TicketMessage) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(ticketmessage.Table, ticketmessage.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, ticketmessage.AuthorTable, ticketmessage.AuthorColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryAttachments queries the attachments edge of a TicketMessage.
func (c *TicketMessageClient) QueryAttachments(_m *TicketMessage) *TicketAttachmentQuery {
	query := (&TicketAttachmentClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(ticketmessage.Table, ticketmessage.FieldID, id),
			sqlgraph.To(ticketattachment.Table, ticketattachment.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ticketmessage.AttachmentsTable, ticketmessage.AttachmentsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *UserClient) QueryTicketEvents(_m *User) *TicketEventQuery {
	query := (&TicketEventClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *UserClient) QueryTicketAttachments(_m *User) *TicketAttachmentQuery {
	query := (&TicketAttachmentClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		...
		SubscriptionPlan, TLSFingerprintProfile, Ticket, TicketAttachment, TicketEvent,
		TicketMessage, UsageCleanupTask, UsageLog, User, UserAllowedGroup,
