...
type GatewayService struct {
	...
	apiKeyRoutingHealthSource APIKeyRoutingHealthProvider
}
...
// DoGrokNativeResponsesJSON 向 Grok 上游发送非流式 Responses 请求，供 `/v1/web_search` 使用。
// 该无 Gin 依赖路径始终使用固定的 Grok CLI 出站身份。
