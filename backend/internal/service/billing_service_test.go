...
func TestGetModelPricing_OpenCodeGoLegacyKimiCodeAliasUsesOfficialModelID(t *testing.T) {
	...
	aliasPricing, err := svc.GetModelPricingForPlatform(OpenCodeGoPricingPlatform, "kimi-k2.7-code")
	require.NoError(t, err)
	prefixedAliasPricing, err := svc.GetModelPricingForPlatform(OpenCodeGoPricingPlatform, "opencode-go/kimi-k2.7-code")
	require.NoError(t, err)
	modelsPrefixedAliasPricing, err := svc.GetModelPricingForPlatform(OpenCodeGoPricingPlatform, "models/opencode-go/kimi-k2.7-code")
	require.NoError(t, err)
	officialPricing, err := svc.GetModelPricingForPlatform(OpenCodeGoPricingPlatform, "kimi-k2.7")
	require.NoError(t, err)
