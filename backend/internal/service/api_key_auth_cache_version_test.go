...
func TestAPIKeyServiceRejectsV14SnapshotWithoutGroupGPT56Inference(t *testing.T) {
	svc := &APIKeyService{}
	...
	if ok || apiKey != nil {
		t.Fatalf("expected v14 auth snapshot to be rejected, got ok=%v apiKey=%#v", ok, apiKey)
	}
}
