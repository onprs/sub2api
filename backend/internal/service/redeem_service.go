	...
	case RedeemTypeSubscription:
		...
		if validityDays < 0 {
			...
			_, _, err := s.subscriptionService.AssignOrExtendSubscription(txCtx, &AssignSubscriptionInput{
				...
				HasRollingQuotaSnapshot: redeemCode.SubscriptionQuotaSnapshotVersion > 0,
				FiveHourLimitUSD:        redeemCode.FiveHourLimitUSD,
				SevenDayLimitUSD:        redeemCode.SevenDayLimitUSD,
				ThirtyDayLimitUSD:       redeemCode.ThirtyDayLimitUSD,
			})
			if err != nil {
