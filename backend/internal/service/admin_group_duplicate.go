...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		DynamicRateMaxMultiplier:        source.DynamicRateMaxMultiplier,
		DynamicRateMinMultiplier:        source.DynamicRateMinMultiplier,
		DynamicRateTargetTokens:         source.DynamicRateTargetTokens,
		DynamicRateWindowMinutes:        source.DynamicRateWindowMinutes,
