...
func TestParseUsageAndEnrichCoverage(t *testing.T) {
	...
	parseUsageAndAccumulate(state, []byte(`{"type":"response.completed","response":{"usage":{"input_tokens":2,"output_tokens":1,"input_tokens_details":{"cached_tokens":1,"cache_write_tokens":4,"cache_creation":{"ephemeral_5m_input_tokens":2,"ephemeral_1h_input_tokens":2}},"output_tokens_details":{"image_tokens":3}}}}`), "response.completed", nil)
