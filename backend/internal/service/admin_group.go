...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	if group.RequireOAuthOnly && (group.Platform == PlatformOpenAI || group.Platform == PlatformAntigravity || group.Platform == PlatformAnthropic || group.Platform == PlatformGemini || group.Platform == PlatformGrok || group.Platform == PlatformClinePass || group.Platform == PlatformOpenRouter || group.Platform == PlatformCommandCode) && len(accountIDsToCopy) > 0 {
