...
func TestAccountTestService_GrokAPIKey429DoesNotPersistRateLimit(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	c, _ := gin.CreateTestContext(recorder)
	c.Request = httptest.NewRequest(http.MethodPost, "/api/v1/admin/accounts/151/test", nil)
...
func TestAccountTestService_GrokImageModelUsesImagesGenerations(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "https://cli-chat-proxy.grok.com/v1/images/generations", upstream.lastReq.URL.String())
...
func TestAccountTestService_GrokImageEditUsesUploadedImage(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "https://cli-chat-proxy.grok.com/v1/images/edits", upstream.lastReq.URL.String())
...
func TestAccountTestService_GrokVideoUpstreamErrorIsNotMaskedAsSuccess(t *testing.T) {
	...
	require.Error(t, err)
	require.Equal(t, "https://cli-chat-proxy.grok.com/v1/videos/generations", upstream.lastReq.URL.String())
