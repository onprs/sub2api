...
var ProviderSet = wire.NewSet(
	...
	NewCommandCodeClient,
	NewCommandCodeGatewayService,
	...
	NewBillingEligibilityService,
	wire.Bind(new(BillingEligibilityResolver), new(*BillingEligibilityService)),
	...
	NewChannelServiceWithCachePubSub,
...
// 避免 local target 在 handler 尚未就绪时启动。quotaFetcher 通过 setter 注入，
// 因为账号用量与 CN 服务在 Wire 图中晚于 ChannelMonitorService 构造。
