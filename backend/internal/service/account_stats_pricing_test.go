...
func TestTryModelFilePricing_Fable51MaxEffortUsesTripleQuota(t *testing.T) {
	...
	tokens := UsageTokens{InputTokens: 100}
	standard := tryModelFilePricingForPlatform(bs, "", "claude-fable-5-1", tokens, "", "xhigh")
	max := tryModelFilePricingForPlatform(bs, "", "claude-fable-5-1", tokens, "", "max")
...
func TestTryModelFilePricing_AppliesLongContextPricing(t *testing.T) {
	...
	result := tryModelFilePricingForPlatform(bs, "", "gpt-5.6-sol", tokens, "")
...
func TestTryModelFilePricing_AppliesServiceTierPricing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := tryModelFilePricingForPlatform(bs, "", "gpt-5.6-sol", tokens, tt.serviceTier)
			require.NotNil(t, result)
...
func TestTryModelFilePricing_CombinesPriorityAndLongContextPricing(t *testing.T) {
	...
	result := tryModelFilePricingForPlatform(bs, "", "gpt-5.6-sol", tokens, "priority")
