...
func deepSeekChatHistoryWithoutReasoning() []byte {
	return []byte(`{
		"model":"gpt-5.6-sol",
		"stream":false,
		"input":[
...
func TestForwardResponses_DeepSeekChatFallbackInjectsReasoningPlaceholder(t *testing.T) {
	body := deepSeekChatHistoryWithoutReasoning()
