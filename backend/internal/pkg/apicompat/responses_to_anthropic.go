...
func ResponsesEventToAnthropicEvents(
	...
	case "response.reasoning_summary_text.done":
		// Keep the thinking block open until output_item.done, where the
		// encrypted_content signature becomes available. A terminal response
		// still closes the block for sparse streams that omit item.done.
		return nil
