...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		createdAt                 time.Time
		dynamicRateMultiplier     sql.NullFloat64
	)
	...
	log := &service.UsageLog{
		...
		DynamicRateMultiplier:     nullFloat64Ptr(dynamicRateMultiplier),
