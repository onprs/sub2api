...
func buildSchedulerMetadataAccount(account service.Account) service.Account {
	return service.Account{
		...
		FirstOutputFailoverTimeoutSeconds:  account.FirstOutputFailoverTimeoutSeconds,
		FirstOutputFailoverCooldownMinutes: account.FirstOutputFailoverCooldownMinutes,
