...
func TestDispatchCodexModelsGatewayUsesGeneratedManifestForDynamicOpenAIKey(t *testing.T) {
	...
	c.Set(string(middleware.ContextKeyAPIKey), &service.APIKey{
		...
		RoutingGroups: []service.APIKeyGroupBinding{
			{GroupID: 1, Group: &service.Group{ID: 1, Platform: service.PlatformOpenAI, Status: service.StatusActive}},
			{GroupID: 2, Group: &service.Group{ID: 2, Platform: service.PlatformOpenAI, Status: service.StatusActive}},
		},
	})
	called := ""
