...
type channelMonitorTemplateCreateRequest struct {
	...
	Provider         string            `json:"provider" binding:"required,oneof=openai anthropic gemini grok opencode clinepass openrouter commandcode antigravity_claude antigravity_gemini"`
