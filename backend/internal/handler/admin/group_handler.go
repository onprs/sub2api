...
type CreateGroupRequest struct {
	...
	Description               string                        `json:"description"`
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai opencode clinepass openrouter commandcode gemini antigravity grok kimi zhipu deepseek minimax composite"`
...
type CompositeRouteRequest struct {
	...
	TargetPlatform string `json:"target_platform" binding:"required,oneof=anthropic openai gemini antigravity grok kimi zhipu deepseek minimax opencode"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		DynamicRateTargetTokens:         req.DynamicRateTargetTokens,
		DynamicRateWindowMinutes:        req.DynamicRateWindowMinutes,
		...
		InferGPT56CacheWrite:            req.InferGPT56CacheWrite,
		InferGPT56CacheWriteMinTokens:   req.InferGPT56CacheWriteMinTokens,
