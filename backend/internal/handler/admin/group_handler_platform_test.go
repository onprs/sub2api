...
// 回归分组平台枚举:kimi/zhipu/deepseek/minimax/opencode 必须能通过 Create/Update 的
...
func TestGroupPlatformBinding_AllowedPlatforms(t *testing.T) {
	allowed := []string{
		...
		"kimi", "zhipu", "deepseek", "minimax", "opencode", "composite",
	}
...
func TestCompositeRouteTargetPlatform_AllowsCNProvidersAndOpenCode(t *testing.T) {
	for _, platform := range []string{"kimi", "zhipu", "deepseek", "minimax", "opencode"} {
