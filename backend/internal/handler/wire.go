...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		userService, concurrencyService, billingCacheService, billingEligibilityService, usageService, apiKeyService, usageRecordWorkerPool,
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, routingService, concurrencyService, billingCacheService, billingEligibilityService, apiKeyService,
...
func ProvideHandlers(
	...
	openCodeGoGatewayHandler *OpenCodeGoGatewayHandler,
	...
	accountObserverHandler *AccountObserverHandler,
	_ *service.IdempotencyCoordinator,
	_ *service.IdempotencyCleanupService,
	_ *service.TicketMaintenanceService,
) *Handlers {
	return &Handlers{
		Auth:             authHandler,
		User:             userHandler,
...
var ProviderSet = wire.NewSet(
	...
	ProvideOpenCodeGoGatewayHandler,
	NewTotpHandler,
	NewPasskeyHandler,
