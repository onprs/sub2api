...
func GroupFromServiceAdmin(g *service.Group) *AdminGroup {
	...
	out := &AdminGroup{
		...
		InferGPT56CacheWriteMinTokens: g.GPT56CacheWriteInferenceMinTokens(),
...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	out := RedeemCode{
		...
		SubscriptionQuotaSnapshotVersion: rc.SubscriptionQuotaSnapshotVersion,
		FiveHourLimitUSD:                 rc.FiveHourLimitUSD,
		SevenDayLimitUSD:                 rc.SevenDayLimitUSD,
		ThirtyDayLimitUSD:                rc.ThirtyDayLimitUSD,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		CacheWriteInferred:        l.CacheWriteInferred,
		...
		DynamicRateMultiplier:     l.DynamicRateMultiplier,
