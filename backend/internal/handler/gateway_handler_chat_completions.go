...
func (h *GatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		case shouldUseAntigravityStandardBridge(account):
			...
			result, err = h.antigravityGatewayService.ForwardStandardAsChatCompletions(c.Request.Context(), c, account, forwardBody, reqModel, false)
		default:
...
func (h *GatewayHandler) chatCompletionsErrorResponse(c *gin.Context, status int, errType, message string) {
	writeProtocolError(c, protocolconv.ProtocolOpenAIChat, status, errType, errType, message)
}
